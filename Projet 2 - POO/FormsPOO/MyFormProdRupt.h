...
namespace FormsPOO {
	...
	/// <summary>
	/// Description résumée de MyFormProdRupt
	/// </summary>
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		try {
			MySqlDataAdapter^ sda = gcnew MySqlDataAdapter("SELECT article.DESIGNATION AS ProduitsARéapprovisionner FROM article WHERE article.QUANTITE_DISPONIBLE < article.SEUIL_REAPPROVISIONNEMENT", con);
